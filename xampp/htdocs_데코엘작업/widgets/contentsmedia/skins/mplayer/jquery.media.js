...
$.fn.media.defaults = {
	...
	params:		{ wmode: 'opaque'},	// added to object element as param elements; added to embed element as attrs
...
$.fn.media.defaults.players = {
	...
	winmedia: {
		...
		mimetype:	  $.browser.mozilla && isFirefoxWMPPluginInstalled() || $.browser.webkit && isFirefoxWMPPluginInstalled() ? 'application/x-ms-wmp' : 'application/x-mplayer2',
