...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.buildNextBackButtons = function() {
			base.$forward = $('<span class="AnTs_arrow forward"><a href="#"><span>' + o.forwardText + '</span></a></span>');
			base.$back = $('<span class="AnTs_arrow back"><a href="#"><span>' + o.backText + '</span></a></span>');
...
*/
		...
		tooltipClass        : "AnTs_tooltip", // Class added to navigation & start/stop button (text copied to title if it is hidden by a negative text indent)
