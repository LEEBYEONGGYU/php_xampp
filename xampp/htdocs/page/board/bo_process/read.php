...
<?php 
	include $_SERVER['DOCUMENT_ROOT']."/include/header.php";
		...
		$hit = mysqli_fetch_array(mq("select * from qa where idx ='".$bno."'"));
		$hit = $hit['hit'] + 1;
		$fet = mq("update qa set hit = '".$hit."' where idx = '".$bno."'");
		$sql = mq("select * from qa where idx='".$bno."'"); /* 받아온 idx값을 선택 */
...
<div id="board_read">
	<h1><?php echo $board['title']; ?></h1>
		<div id="user_info">
			<?php echo $board['userid']; ?> <?php echo $board['w_date']; ?> 조회:<?php echo $board['hit']; ?>
				<div id="bo_line"></div>
			</div>
			<div>
