  ...
  <h1>jQuery 장바구니 예제</h1>
    <div id="mylist">
      ...
      <table class="list-table">
        ...
        <?php
          $sql = mq("select * from product where userid='".$_SESSION['userid']."' order by  idx desc");  
          while($product = $sql->fetch_array()){?>
        <tbody>
          <tr>
            <td width="100"><?php echo $product['idx']; ?></td>
            <td width="170"><img src="../../img/<?php echo $product['pro_pic']; ?>.png" width="120" height="80" /></td>
