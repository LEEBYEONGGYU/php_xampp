					...
					<table>
						...
						<tr>
							...
							<option value="hanmail.com">hanmail.com</option></select></td>
                                                	...
                                                	<tr>
							<td>년</td>
							<td><input type="text" size="35" name="year" placeholder="년" required></td>
						</tr>
						<tr>
							<td>월</td>
							<td><input type="text" size="35" name="month" placeholder="월" required></td>
						</tr>

                                                <tr>
							<td>일</td>
							<td><input type="text" size="35" name="day" placeholder="일" required></td>
						</tr>
						<tr>
							<td>성별</td>
							<td>남<input type="radio" name="sex" value="남"> 여<input type="radio" name="sex" value="성별"></td>
						</tr>
