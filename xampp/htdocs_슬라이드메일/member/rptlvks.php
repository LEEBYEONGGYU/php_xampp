...
<div id="board_area"> 
  <h1>게시판</h1>
  <h4>동아리의 활동을 확인할 수 있는 게시판입니다.</h4>
    <table class="list-table">
      <thead>
        ...
        <div id="write_btn">
        <a href="login.php"><button>글쓰기</button></a>
    </div>
        <?php
          $sql = mq("select * from member order by idx desc limit 0,5"); // board테이블에있는 idx를 기준으로 내림차순해서 5개까지 표시
